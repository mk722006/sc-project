def global_report(month, year, selected_country, table_name, conn, curr):
    ...
    if selected_country == 'Global': 
        ...
        copy_wb.sheets(sheet_name).range('B20').value = B20_cell_value
        copy_wb.sheets(sheet_name).range('D20').value = D20_cell_value
        ...
        for run in range(len(market_df)-1):
            ...
            copy_wb.sheets(sheet_name).range(cell_name_D).value = round(cell_value_spend_ytd, 2)
            ...
            copy_wb.sheets(sheet_name).range(cell_name_E).value = cell_value_percentage_ytd
    ...
    if selected_country == 'Global': 
        ...
        copy_wb.sheets(sheet_name).range('B57').value = all_others
        copy_wb.sheets(sheet_name).range('C57').value = all_others_percentage
        
        all_others, all_others_percentage = getting_all_others_info(top_manufacturers_by_category_spend_pharma)
        copy_wb.sheets(sheet_name).range('F57').value = all_others
        copy_wb.sheets(sheet_name).range('G57').value = all_others_percentage
        
        all_others, all_others_percentage = getting_all_others_info(top_manufacturers_by_category_spend_indirect)
        copy_wb.sheets(sheet_name).range('J57').value = all_others
        copy_wb.sheets(sheet_name).range('K57').value = all_others_percentage
    ...
    if selected_country == 'Global': 
        ...
        copy_wb.sheets(sheet_name).range('B63').value = f'{month_year_abbr} ( {curr_symbol} )'  # Ex: Apr-23 ( USD )
        copy_wb.sheets(sheet_name).range('B74').value = f"{month_year_abbr.split('-')[0]} YTD {curr_symbol}"  # Ex: Apr YTD USD 
        
        # Writing in Cells - D74, E74, F74, G74 | Headers 
        copy_wb.sheets(sheet_name).range('D74').value = three_months_prior[-1]  # Jan-23
        copy_wb.sheets(sheet_name).range('E74').value = two_months_prior[-1]  # Feb-23
        copy_wb.sheets(sheet_name).range('F74').value = one_month_prior[-1]  # Mar-23
        copy_wb.sheets(sheet_name).range('G74').value = current_date[-1]  # Apr-23
    ...
    if selected_country == 'Global': 
        ...
        copy_wb.sheets(sheet_name).range('A85').value = f'Top Suppliers {month_year_abbr} MTD'  # Ex: Top Suppliers  Apr-23  MTD
        copy_wb.sheets(sheet_name).range('D85').value = f'Top Suppliers {month_year_abbr} YTD'  # Ex: Top Suppliers  Apr-23  YTD
        
        copy_wb.sheets(sheet_name).range('G85').value = f'Top Manufacturers {month_year_abbr} MTD'  # Ex: Top Manufacturers  Apr-23  MTD
        copy_wb.sheets(sheet_name).range('J85').value = f'Top Manufacturers {month_year_abbr} YTD'  # Ex: Top Manufacturers  Apr-23  YTD
        
        copy_wb.sheets(sheet_name).range('A100').value = f'Top Product Categories {month_year_abbr} MTD'  # Ex: Top Product Categories  Apr-23  MTD
        copy_wb.sheets(sheet_name).range('G100').value = f'Top Product Categories {month_year_abbr} YTD'  # Ex: Top Product Categories  Apr-23  YTD
        ...
        copy_wb.sheets(sheet_name).range('B97').value = all_others
        copy_wb.sheets(sheet_name).range('C97').value = all_others_percentage
        
        all_others, all_others_percentage = getting_all_others_info(direct_non_pharma_spend_top_suppliers_value_ytd) # | Top Suppliers
        copy_wb.sheets(sheet_name).range('E97').value = all_others
        copy_wb.sheets(sheet_name).range('F97').value = all_others_percentage
        ...
        copy_wb.sheets(sheet_name).range('H97').value = all_others
        copy_wb.sheets(sheet_name).range('I97').value = all_others_percentage
        ...
        copy_wb.sheets(sheet_name).range('K97').value = all_others
        copy_wb.sheets(sheet_name).range('L97').value = all_others_percentage
        ...
        copy_wb.sheets(sheet_name).range('E106').value = all_others
        copy_wb.sheets(sheet_name).range('F106').value = all_others_percentage

        all_others, all_others_percentage = getting_all_others_info(direct_non_pharma_spend_top_product_categories_value_ytd) 
        copy_wb.sheets(sheet_name).range('K106').value = all_others
        copy_wb.sheets(sheet_name).range('L106').value = all_others_percentage
    ...
    if selected_country == 'Global': 
        ...
        copy_wb.sheets(sheet_name).range('B114').value = f'{month_year_abbr} ( {curr_symbol} )'  # Ex: Apr-23 ( USD )
        
        
        # Writing in Cells - B125, D125, E125, F125, G125 | Headers 
        copy_wb.sheets(sheet_name).range('B125').value = f"{month_year_abbr.split('-')[0]} YTD {curr_symbol}"  # Ex: Apr YTD USD 
        copy_wb.sheets(sheet_name).range('D125').value = three_months_prior[-1]  # Jan-23
        copy_wb.sheets(sheet_name).range('E125').value = two_months_prior[-1]  # Feb-23
        copy_wb.sheets(sheet_name).range('F125').value = one_month_prior[-1]  # Mar-23
        copy_wb.sheets(sheet_name).range('G125').value = current_date[-1]  # Apr-23
    ...
    if selected_country == 'Global': 
        ...
        copy_wb.sheets(sheet_name).range('A138').value = f'Top Suppliers {month_year_abbr} MTD'  # Ex: Top Suppliers  Apr-23  MTD
        copy_wb.sheets(sheet_name).range('D138').value = f'Top Suppliers {month_year_abbr} YTD'  # Ex: Top Suppliers  Apr-23  YTD
        
        copy_wb.sheets(sheet_name).range('G138').value = f'Top Manufacturers {month_year_abbr} MTD'  # Ex: Top Manufacturers  Apr-23  MTD
        copy_wb.sheets(sheet_name).range('J138').value = f'Top Manufacturers {month_year_abbr} YTD'  # Ex: Top Manufacturers  Apr-23  YTD
        
        copy_wb.sheets(sheet_name).range('A154').value = f'Top Product Categories {month_year_abbr} MTD'  # Ex: Top Product Categories  Apr-23  MTD
        copy_wb.sheets(sheet_name).range('G154').value = f'Top Product Categories {month_year_abbr} YTD'  # Ex: Top Product Categories  Apr-23  YTD
        ...
        copy_wb.sheets(sheet_name).range('B150').value = all_others
        copy_wb.sheets(sheet_name).range('C150').value = all_others_percentage
        
        all_others, all_others_percentage = getting_all_others_info(direct_pharma_spend_top_suppliers_value_ytd) # | Top Suppliers
        copy_wb.sheets(sheet_name).range('E150').value = all_others
        copy_wb.sheets(sheet_name).range('F150').value = all_others_percentage
        ...
        copy_wb.sheets(sheet_name).range('H150').value = all_others
        copy_wb.sheets(sheet_name).range('I150').value = all_others_percentage
        ...
        copy_wb.sheets(sheet_name).range('K150').value = all_others
        copy_wb.sheets(sheet_name).range('L150').value = all_others_percentage
        ...
        copy_wb.sheets(sheet_name).range('E160').value = all_others
        copy_wb.sheets(sheet_name).range('F160').value = all_others_percentage
        ...
        copy_wb.sheets(sheet_name).range('K160').value = all_others
        copy_wb.sheets(sheet_name).range('L160').value = all_others_percentage
    ...
    if selected_country == 'Global': 
        ...
        copy_wb.sheets(sheet_name).range('B168').value = f'{month_year_abbr} ( {curr_symbol} )'  # Ex: Apr-23 ( USD )
        
        
        # Writing in Cells - G168, I168, J168, K168, L168 | Headers 
        copy_wb.sheets(sheet_name).range('G168').value = f"{month_year_abbr.split('-')[0]} YTD {curr_symbol}"  # Ex: Apr YTD USD 
        copy_wb.sheets(sheet_name).range('I168').value = three_months_prior[-1]  # Jan-23
        copy_wb.sheets(sheet_name).range('J168').value = two_months_prior[-1]  # Feb-23
        copy_wb.sheets(sheet_name).range('K168').value = one_month_prior[-1]  # Mar-23
        copy_wb.sheets(sheet_name).range('L168').value = current_date[-1]  # Apr-23
    ...
    if selected_country == 'Global': 
        ...
        copy_wb.sheets(sheet_name).range('A178').value = f'Top Suppliers {month_year_abbr} MTD'  # Ex: Top Suppliers  Apr-23  MTD
        copy_wb.sheets(sheet_name).range('D178').value = f'Top Suppliers {month_year_abbr} YTD'  # Ex: Top Suppliers  Apr-23  YTD
        
        copy_wb.sheets(sheet_name).range('G178').value = f'Top Manufacturers {month_year_abbr} MTD'  # Ex: Top Manufacturers  Apr-23  MTD
        copy_wb.sheets(sheet_name).range('J178').value = f'Top Manufacturers {month_year_abbr} YTD'  # Ex: Top Manufacturers  Apr-23  YTD
        
        copy_wb.sheets(sheet_name).range('A193').value = f'Top Product Categories {month_year_abbr} MTD'  # Ex: Top Product Categories  Apr-23  MTD
        copy_wb.sheets(sheet_name).range('G193').value = f'Top Product Categories {month_year_abbr} YTD'  # Ex: Top Product Categories  Apr-23  YTD
        ...
        copy_wb.sheets(sheet_name).range('B190').value = all_others
        copy_wb.sheets(sheet_name).range('C190').value = all_others_percentage
        
        all_others, all_others_percentage = getting_all_others_info(indirect_spend_top_suppliers_value_ytd) # | Top Suppliers
        copy_wb.sheets(sheet_name).range('E190').value = all_others
        copy_wb.sheets(sheet_name).range('F190').value = all_others_percentage
        
        all_others, all_others_percentage = getting_all_others_info(indirect_spend_top_manufacturers_value_mtd) # | Top Manufacturers
        copy_wb.sheets(sheet_name).range('H190').value = all_others
        copy_wb.sheets(sheet_name).range('I190').value = all_others_percentage
        
        all_others, all_others_percentage = getting_all_others_info(indirect_spend_top_manufacturers_value_ytd) # | Top Manufacturers
        copy_wb.sheets(sheet_name).range('K190').value = all_others
        copy_wb.sheets(sheet_name).range('L190').value = all_others_percentage
        ...
        copy_wb.sheets(sheet_name).range('E199').value = all_others
        copy_wb.sheets(sheet_name).range('F199').value = all_others_percentage
        ...
        copy_wb.sheets(sheet_name).range('K199').value = all_others
        copy_wb.sheets(sheet_name).range('L199').value = all_others_percentage
    # Sheet2 | Updating
    ...
    for cell_number in range(2, 6):
        ...
        for i, col_name in enumerate(col_names):
            ...
            copy_wb.sheets('Sheet2').range(f'{col_name}{cell_number}').value = cell_value
            sum = sum+1
    ...
    value = curr.fetchall()
    # print(value)
    copy_wb.sheets(sheet_name).range('A59').value = f"*Total unique mfg {list(value[0].values())[0]}"
    ...
    value = curr.fetchall()
    # print(value)
    copy_wb.sheets(sheet_name).range('E59').value = f"*Total unique mfg {list(value[0].values())[0]}"
    ...
    value = curr.fetchall()
    # print(value)
    copy_wb.sheets(sheet_name).range('I59').value = f"*Total unique mfg {list(value[0].values())[0]}"
